...
export default function Navigation() {
  ...
  return (
    <nav className="relative top-0 left-0 w-full flex justify-between items-center p-6 bg-black backdrop-blur-sm">
      ...
      >
        {walletAddress ? `Connected: ${walletAddress.substring(0, 6)}...${walletAddress.slice(-4)}` : 'Connect'}
        <Wallet size={16} />
      </button>
    </nav>
  );
